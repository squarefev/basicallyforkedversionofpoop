...
# Partitions & Filesystems (FIXED: Added EROFS driver flags for system/vendor/product)
...
# Dynamic Partitions (FIXED: Group label typo fixed from 'realme' to standard 'infinix')
BOARD_SUPER_PARTITION_SIZE := 9126805504
BOARD_SUPER_PARTITION_GROUPS := infinix_dynamic_partitions
BOARD_INFINIX_DYNAMIC_PARTITIONS_PARTITION_LIST := system system_ext vendor product system_dlkm
...
# Decryption Configuration (FIXED: Mapped Crypto parameters to Android 13/14 Keymint layout)
TW_INCLUDE_CRYPTO := true
TW_INCLUDE_CRYPTO_FBE := true
TW_USE_FSCRYPT_POLICY := 2
BOARD_USES_QCOM_FCRYPT := false
...
# TWRP / OrangeFox Visual Configuration
...
TW_DEVICE_VERSION := X6525-Massatrio16
...
# Decryption Library Relink Array (FIXED: Cleaned trailing escape characters and duplicate links)
